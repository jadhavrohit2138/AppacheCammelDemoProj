...
public class EmpService {
    ...
    public Boolean deleteEmp(int emp_id) throws ValidationException {
    ...
    public Boolean updateEmp(Integer emp_id, EmpBean employeeRequest) throws ValidationException {
